...
#ifdef __TESTING_REGISTRATION__
...
void registration_test(void *params) {
  ...
  ESP_LOGI(TAG, "~ registration_test()");
}
...
void fw_run(void) {
  ...
  xTaskCreatePinnedToCore(&registration_test     ,"registration_test"    ,1024*8 ,NULL ,5 ,NULL ,1);
