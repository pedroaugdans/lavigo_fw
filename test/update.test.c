...
/*TEST DEFINITIONS*/
/*************************************UPDATE CONFIG****************************************************/
#define TEST_URL "https://s3.amazonaws.com/bin-test.lavigo.io/develop/hubware.bin"
/******************************************************************************************************/
...
void update_test(void *params) {
  ESP_LOGI(TAG, " update_test()");
...
void fw_run(void) {
  ...
  xTaskCreatePinnedToCore(&update_test   ,"update_test"    ,1024*8 ,NULL ,5 ,NULL ,1);
